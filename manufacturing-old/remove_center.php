...
if (isset($_POST['addissue']) && can_process())
{
    ...
    $failed_data= delete_sys_grp($_POST['Location'],$_POST['stock_id'],$_POST['sl_no'],$_POST['sysid'],$_POST['date_'],$_POST['status'],$_POST['status'],$_POST['return_status'],$_POST['memo_']);


   // $Ajax->redirect('manage/group_center.php?closed=closed');
...
remove_grpcenter_items($cent,$stock_id,$loc,$location,$sys);
echo "</td></tr>";

end_table();

submit_center('addissue', _("ADD"), true, '', 'default');
