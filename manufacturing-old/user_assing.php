...
if (isset($_POST['addissue']) && can_process())
{
	...
	$failed_data = add_user_issues($_POST['name'],
		$_POST['floor'],
		$_POST['room'], $_POST['department'],$_POST['seat'], $_POST['date_'], $_POST['department_id'],$_POST['employee_id']);
...
start_form();
display_search_details('U');

div_start('controls', 'items_table');
display_user_requirements($_POST['seat'],'');
div_end();
$Ajax->activate('items_table');
echo "<br>";
